                ...
                <div className="footer-layout">
                    <div className="footer">
                        <div className="header-title">
                            <h3 className='header-title1 foot-head'>Techies</h3>
                    ...
                    <div className="footer">
                        ...
                        <p className="footer-item"><FaPhoneAlt className='contact-icon' />+91 852369742</p>
                        <p className="footer-item"><IoMail className='contact-icon' />techies@gmail.com</p>
